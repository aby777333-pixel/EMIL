...
| Research terminal / global market dashboard (§12–13) | ROUND 1 (v1) + ROUND 5 crypto | **Round 5:** "Crypto — live from the venues" board on /markets: Deribit + Delta India perps (last/mark/index, 24h, 8h funding, OI, volume) and Gemini spot from public tickers, no key, cached 30 s. | /markets: global market clock, indices/metals/energy board (LIVE with the owner's Twelve Data key, 8-symbol free-tier budget, 10-min server cache), FX reference, crypto, personal watchlist. **Round 15:** `/heatmap` — Heatmap & Breadth from free cached feeds: FX strength vs USD (ECB fixings via Frankfurter, 1d/1w, G10 vs EM), CoinGecko top-25 (24h/7d, market-cap weighted tiles), the research board (ETF proxies labelled); breadth per group (% advancing, avg move, best/worst); tiles deep-link to charts. Country terminals: still MISSING (need equity feeds/keys). |
...
## Round 15 (2026-09-03 night) — Heatmap & Breadth
