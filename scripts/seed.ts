...
async function main() {
  ...
  const FLAG_DEFAULTS = [
    ...
    { key: 'options_analytics', label: 'Options analytics', description: 'Options terminal (spec §25) on Deribit public marks: chain, ATM IV term structure, put/call OI, max pain, skew. Research only.', enabled: true },
