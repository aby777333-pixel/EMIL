...
export const MARKETS: MarketDef[] = [
  ...
  { key: 'asia_stocks', name: 'Asia-Pacific Stocks', region: 'APAC', exchanges: 'TSE, HKEX, SGX, ASX', assetClasses: 'stocks', description: 'Japan, Hong Kong, Singapore and Australia equities. Structure ready; data feed to follow.', dataStatus: 'coming_soon', sortOrder: 90 },
  { key: 'uk_stocks', name: 'UK Stocks', region: 'United Kingdom · GMT', exchanges: 'LSE', assetClasses: 'stocks', description: 'London Stock Exchange equities and the FTSE complex. Structure ready; data feed to follow.', dataStatus: 'coming_soon', sortOrder: 100 },
  { key: 'canada_stocks', name: 'Canada Stocks', region: 'Canada · ET', exchanges: 'TSX, TSXV', assetClasses: 'stocks', description: 'Canadian equities on the Toronto Stock Exchange. Structure ready; data feed to follow.', dataStatus: 'coming_soon', sortOrder: 110 },
  { key: 'mena_stocks', name: 'Middle East Stocks', region: 'MENA · GST/AST', exchanges: 'Tadawul, ADX, DFM, EGX', assetClasses: 'stocks', description: 'Gulf and MENA equities — Saudi Tadawul, Abu Dhabi, Dubai, Egypt. Structure ready; data feed to follow.', dataStatus: 'coming_soon', sortOrder: 120 },
  { key: 'africa_stocks', name: 'Africa Stocks', region: 'Africa', exchanges: 'JSE, NGX', assetClasses: 'stocks', description: 'Johannesburg and Nigerian exchanges. Structure ready; data feed to follow.', dataStatus: 'coming_soon', sortOrder: 130 },
  { key: 'latam_stocks', name: 'Latin America Stocks', region: 'LatAm', exchanges: 'B3, BMV', assetClasses: 'stocks', description: 'Brazil B3 and Mexico BMV equities. Structure ready; data feed to follow.', dataStatus: 'coming_soon', sortOrder: 140 },
]
